...
object NoApplet : BaseDelayableConditionalHookAdapter("noapplet") {
    ...
    override val conditionCache: PageFaultHighPerformanceFunctionCache<Boolean> = PageFaultHighPerformanceFunctionCache { hostInfo.versionCode>=QQVersion.QQ_8_0_0}
