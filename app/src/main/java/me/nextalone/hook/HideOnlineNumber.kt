...
object HideOnlineNumber : BaseDelayableHook() {
    private const val na_hide_online_number: String = "na_hide_online_number"
    var isInit = false
...
//            val classSimpleName = this::class.java.simpleName
    ...
    override fun isEnabled(): Boolean {
        return try {
            ConfigManager.getDefaultConfig().getBooleanOrFalse(na_hide_online_number)
    ...
    override fun setEnabled(enabled: Boolean) {
        try {
            ...
            mgr.allConfig[na_hide_online_number] = enabled
            mgr.save()
        } catch (e: Exception) {
            Utils.log(e)
