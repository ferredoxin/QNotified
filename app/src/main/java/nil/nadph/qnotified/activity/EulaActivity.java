...
public class EulaActivity extends IphoneTitleBarActivityCompat implements View.OnClickListener {
    ...
    public boolean doOnCreate(Bundle bundle) {
        ...
        sb.append("请务必仔细阅读和理解QNotified最终用户许可协议（“本《协议》”）中规定的所有权利和限制。在使用前，您需要仔细阅读并决定接受或不接受本《协议》的条款。除非或直至您接受本《协议》的条款，否则本“软件”不得在您的任何终端上安装或使用。\n" +
                "本《协议》是您与本软件作者之间有关的法律协议。本“软件”包括随附的软件，并可能包括相关文档印刷材料。您一旦使用本“软件”，即表示您同意接受本《协议》各项条款的约束。如您不同意本《协议》中的条款，您则应当立即卸载本“软件”。\n" +
                "本“软件”权利只许可使用，而不出售。\n");
        appendEx2(sb, BOLD, "一．本“软件”作者将本“软件”的非专有的使用权授予您。 您可以：\n");
        sb.append("  1.在一台个人所有终端上安装、使用、显示、运行（“运行”）本“软件” 的一份副本。本“软件”为个人版软件，仅供个人所有终端使用，不得用于法人或其他组织（包括但不限于政府机关、公司、企事业单位、其他组织等；无论该组织是否为经济性组织；无论该组织的使用是否构成商业目的使用）所有终端。如若个人所有终端长期固定为法人或其他组织服务，则将被视为“法人或其他组织所有终端”，无法享受本授权。任何超出上述授权范围的使用均被视为非法复制的盗版行为，本“软件”作者保留权利要求相关责任人承担相应的法律责任包括但不限于民事责任、行政责任、刑事责任。\n" +
                ...
                "  4.对本“软件”进行反向工程、反向编译或反汇编；或试图进行任何获得本“软件”原代码的访问或行为。\n");
        appendEx2(sb, BOLD, "二．您保证：\n");
        sb.append("  1.不在本《协议》规定的条款之外，使用、复制、修改或转让本“软件”或其中的任一部分。\n" +
                "  2.只在一台个人所有终端上使用本“软件”；一份软件许可不得在不同的终端上共同或同时使用。\n" +
                "  3.只在以下前提完全满足的情况下，将本“软件”用于多用户环境或网络系统上：\n" +
                "        本“软件”明文许可用于多用户环境或网络系统上；\n" +
                "        使用本“软件”的每一节点及终端都已获得使用许可。\n" +
                "  5.不得出售、二次贩卖、发行、出租、信息网络传播、翻译本“软件”。\n" +
                "  6.在本“软件”的所有副本上包含所有的版权标识。\n" +
                "  7.以任何方式商用本“软件”, 包括但不限于使用本“软件”进行群发, 代发并获取利润, 或出售、二次贩卖、发行、出租本“软件”。");
        appendEx2(sb, BOLD, "三．权利的保留：\n");
        sb.append("  未明示授予的一切权利均为本“软件”作者所有。\n");
        appendEx2(sb, BOLD, "四．本“软件”的著作权：\n");
        ...
        sb.append("  1.用户在下载并使用本“软件”时均被视为已经仔细阅读本条款并完全同意。凡以任何方式激活本软件，或直接、间接使用本“软件”，均被视为自愿接受相关声明和用户服务协议的约束。\n" +
                ...
                "  8.相关声明版权及其修改权、更新权和最终解释权均属本软件方所有。\n" +
                "  9.如您不接受以上声明协议，请停止使用并立即卸载删除本软件。\n");
        appendEx2(sb, BOLD, "六．终解释权归本“软件”作者所有\n");
        ...
        tv.setGravity(Gravity.CENTER);
        tv.setTextColor(ResUtils.skin_black);
        tv.setText("\n注意: 本软件是免费软件!\nQNotified自始至终都是免费使用，如果有你发现有人盗取牟利(倒卖或代发)，请拒绝并不遗余力地在一切平台举报投诉他！\n");
        ll.addView(tv, stdlp);
    ...
    public static void appendEx2(SpannableStringBuilder sb, Object span, String text) {
        int start = sb.length();
        sb.append(text);
