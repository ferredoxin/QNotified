...
import nil.nadph.qnotified.hook.kyuubiran.AutomaticMosaicName;
import nil.nadph.qnotified.hook.kyuubiran.TestQQMe;
import nil.nadph.qnotified.hook.kyuubiran.RemoveGroupApp;
...
//            ll.addView(newListItemHookSwitchInit(this, "群应用爬", "啊这", RemoveGroupApp.INSTANCE));
    ...
    protected void onResume() {
        super.onResume();
        __tv_chat_tail_status.setText(ChatTailHook.get().isEnabled() ? ChatTailHook.get().getTailCapacity().replace("\n", "") : "[未启用]");
    }
}
