    ...
    public Method getMethodInstance(ClassLoader classLoader) throws NoSuchMethodException {
        try {
            ...
            for (Method m : clz.getDeclaredMethods()) {
                if (m.getName().equals(methodName) && getMethodTypeSig(m).equals(signature)) return m;
            }
            ...
            throw new NoSuchMethodException(declaringClass + "->" + methodName + signature);
        } catch (ClassNotFoundException e) {
            throw (NoSuchMethodException) new NoSuchMethodException(declaringClass + "->" + methodName + signature).initCause(e);
        }
    }
