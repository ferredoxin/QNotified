    ...
    public static AbsDelayableHook[] queryDelayableHooks() {
        if (sAllHooks == null) {
            sAllHooks = new AbsDelayableHook[]{
                ...
                cn.lliiooll.hook.MuteAllMsgHook.get(),
                cn.lliiooll.hook.MuteCardMsgHook.get(),
                cn.lliiooll.hook.MuteRedPacketMsgHook.get(),
                cn.lliiooll.hook.MuteTroopAtAllMsgHook.get(),
            };
        }
        return sAllHooks;
    }
