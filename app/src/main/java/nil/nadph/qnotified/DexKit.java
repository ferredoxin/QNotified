...
public class DexKit {
    ...
    public static void a() throws IOException {
        ...
        short type;
        int size;
        int pStringDataItem = 0, pClassDataItem = 0, pCodeItem = 0, pTypeList = 0, pMapList = 0, pClassDefItem = 0, pMethodIdItem = 0, pFieldIdItem = 0, pProtoIdItem = 0, pTypeIdItem = 0, pStringIdItem = 0;
