...
public class RikkaCustomDeviceModelDialog extends RikkaDialog.RikkaConfigItem {
    ...
    public void onClick(View v) {
        ...
        TextView previewManufacturer = vg.findViewById(R.id.textViewCustomDeviceManufacturerPreview);
        TextView previewModel = vg.findViewById(R.id.textViewDeviceModelPreview);
        
        TextView inputManufacturer = vg.findViewById(R.id.editTextCustomDeviceManufacturer);
        TextView inputModel = vg.findViewById(R.id.editTextCustomDeviceModel);
        
        CheckBox enable = vg.findViewById(R.id.checkBoxEnableCustomDeviceModel);
        
        LinearLayout panel = vg.findViewById(R.id.layoutCustomDeviceModelPreview);
