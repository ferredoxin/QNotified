 ...
 * IXposedHookZygoteInit,并将自己的一个服务注册为系统服务，这种就必须重启了 Created by DX on 2017/10/4.
 */
...
public class HookLoader implements IXposedHookLoadPackage {
            ...
            XposedHelpers.findAndHookMethod(Application.class, "attach", Context.class,
                new XC_MethodHook(1250) {
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        invokeHandleHookMethod(context, modulePackage, handleHookClass,
                            handleHookMethod, loadPackageParam);
                    }
                });
        }
    }
    ...
    private void invokeHandleHookMethod(Context context, String modulePackageName,
        ...
        Method method = cls
            .getDeclaredMethod(handleHookMethod, XC_LoadPackage.LoadPackageParam.class);
