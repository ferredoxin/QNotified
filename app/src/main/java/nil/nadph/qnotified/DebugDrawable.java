...
public class DebugDrawable extends Drawable{
	...
	public void draw(Canvas canvas){
		...
		drawRect(canvas,paint,1,1,canvas.getWidth()-1,canvas.getHeight()-1);
		/*
		...
		int lineLength = i8;
		int lineWidth = i1;
		drawRectCorners(canvas,0,0,canvas.getWidth(),canvas.getHeight(),/* c.getLeft(), c.getTop(), c.getRight(), c.getBottom(),*/
