...
public class MuteTroopAtAllMsgHook extends CommonDelayableHook {
    private static final MuteTroopAtAllMsgHook self = new MuteTroopAtAllMsgHook();
    
    private MuteTroopAtAllMsgHook() {
        super("qn_mutecard_msg");
    }
    
    public static MuteTroopAtAllMsgHook get() {
        return self;
    }
