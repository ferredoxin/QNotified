...
public class MuteRedBagMsgHook extends CommonDelayableHook {
    private static final MuteRedBagMsgHook self = new MuteRedBagMsgHook();

    private MuteRedBagMsgHook() {
        super("qn_mutewallent_msg");
    }

    public static MuteRedBagMsgHook get() {
        return self;
    }
